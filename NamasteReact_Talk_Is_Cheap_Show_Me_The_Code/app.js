...
const Header = () => {
    return (
        <div className="header">
            <div>
                <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAC5QRBr_Y2cbXmPFr4r1rnPUSeSjucZqcPA&s" alt="Logo" />
            </div>
...
// The resList is a JSON array that contains data for displaying restaurant cards. Each item in the resList holds information about a specific restaurant.
...
// Accessing resList data inside RestaurantCard component
